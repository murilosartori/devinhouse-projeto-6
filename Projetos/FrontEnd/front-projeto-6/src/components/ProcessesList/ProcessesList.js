  ...
  return (
    <>
      ...
      <AlertDialog
        ...
        description="Deseja realmente excluir o processo?"
      />
      {keycloak.token === undefined ? (
        <Styled.Box>
          <Styled.Paper>
            <Typography align="center">
              Para acessar os recursos do site, você precisa estar logado no sistema.
            </Typography>
          </Styled.Paper>
        </Styled.Box>
      ) : (
                ...
                {emptyFind ? (
                  ...
                  <>
                    {Object.entries(processes).length === 0 ? (
                      <>
                        <Typography>
                          Nenhum processo cadastrado, deseja cadastrar um agora?
                        </Typography>
                      </>
                    ) : (
                      <>
